DROP DATABASE IF EXISTS shop_SM;
CREATE DATABASE shop_SM;
USE shop_SM;
...
INSERT INTO comments (`name`, `text`, createdAt)
VALUES 
('Андрей', 'Все супер!', '2021-05-26 12:53:31'),
('Алена', 'Мне не понравилось(', '2021-05-26 15:53:31'),
('Макс', 'Высшее качество обслуживания!', '2021-05-28 12:53:31'),
('Леха', 'Я больше ни ногой', '2021-05-29 19:53:31'),
('Наташа', 'таким как ты никогда ничего не нравится', '2021-05-30 10:53:31');
...
INSERT INTO users (login, pass, `hash`)
VALUES 
('admin', '123', 'qwe567'),
('user', '321', '');